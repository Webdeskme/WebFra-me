...
class marketpublisher{
	...
	var $publisher_oauth_url = "https://market.webdesk.me/web.php?type=Apps&app=MarketCentral&sec=oauthRequest.php";
	var $user_token;
	private $user_apps = array();
	...
	public function get_published_apps(){
		...
		if($this->get_user_token()){
			...
			$apps = json_decode($this->post_page($this->publisher_api_url, array(
				"method" => "getUserApps",
				"token" => $this->get_user_token()
			)),true);
			
			return $apps["data"]["resultset"]["apps"];
