  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="<?php wd_url($wd_type, $wd_app, 'startMhud.php', ''); ?>">Back</a></li>
        ...
        <li class="active"><a href="<?php wd_url($wd_type, $wd_app, 'startMhud.php', ''); ?>">Mobile HUD</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><?php wd_confirm($wd_type, $wd_app, 'MHUDSubDelete.php', '&MyApp=' . $MyApp, '1', '<i class="glyphicon glyphicon-trash"> Delete</i>'); ?></li>
      </ul>
    </div>
  </div>
</nav>
<form method="post" action="<?php wd_urlSub($wd_type, $wd_app, 'MHUDSub.php', ''); ?>" style="width: 90%; height: 70%;">
...
if(file_exists("MHUD/" . $MyApp)){
    echo htmlspecialchars(file_get_contents("MHUD/" . $MyApp));}
?></textarea>
    <br>
