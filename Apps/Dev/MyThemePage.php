  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="<?php wd_url($wd_type, $wd_app, 'MyTheme.php', '&MyApp=' . $MyApp); ?>">Back</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><?php wd_confirm($wd_type, $wd_app, 'MyThemePageSubDelete.php', '&MyApp=' . $MyApp . '&MyPage=' . $MyPage, '1', '<i class="glyphicon glyphicon-trash"> Delete</i>'); ?></li>
      </ul>
    </div>
  </div>
</nav>
<form method="post" action="<?php wd_urlSub($wd_type, $wd_app, 'MyThemePageSub.php', ''); ?>" style="width: 90%; height: 70%;">
...
if(file_exists("www/Themes/" . $MyApp . "/" . $MyPage)){
    echo htmlspecialchars(file_get_contents("www/Themes/" . $MyApp . "/" . $MyPage));}
?></textarea>
    <br>
