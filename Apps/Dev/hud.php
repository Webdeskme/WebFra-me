  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="<?php wd_url($wd_type, $wd_app, 'startHud.php', ''); ?>">Back</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><?php wd_confirm($wd_type, $wd_app, 'HUDSubDelete.php', '&MyApp=' . $MyApp, '1', '<i class="glyphicon glyphicon-trash"> Delete</i>'); ?></li>
      </ul>
    </div>
  </div>
</nav>
