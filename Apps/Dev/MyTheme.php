  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="<?php wd_url($wd_type, $wd_app, 'startTheme.php', ''); ?>">Back</a></li>
        <li><a href="<?php wd_url($wd_type, $wd_app, 'start.php', ''); ?>">Apps</a></li>
        <li><a href="<?php wd_url($wd_type, $wd_app, 'startApl.php', ''); ?>">Applets</a></li>
        <li class="active"><a href="<?php wd_url($wd_type, $wd_app, 'startTheme.php', ''); ?>">Themes</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><?php wd_confirm($wd_type, $wd_app, 'MyThemeSubDelete.php', '&MyApp=' . $MyApp, '1', '<span class="glyphicon glyphicon-trash"></span> Delete'); ?></li>
      </ul>
    </div>
  </div>
</nav>
...
<form method="post" action="<?php wd_urlSub($wd_type, $wd_app, 'MyThemeSub.php', ''); ?>">
...
<form action="<?php wd_urlSub($wd_type, $wd_app, 'uploadTheme.php', ''); ?>" method="post" enctype="multipart/form-data">
...
<?php
$x = 0;
foreach (scandir('www/Themes/' . $MyApp . '/') as $entry){
                    if ($entry != "." && $entry != "..") {
?>
<tr><td>
<?php
...
echo $x . ": ";
?>
    <a href="<?php wd_url($wd_type, $wd_app, 'MyThemePage.php', '&MyApp=' . $MyApp . '&MyPage=' . $entry); ?>"><?php echo $entry; ?></a></td></tr>
<?php
}
}
?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="http://webdesk.me/indexSub.php?page=marketSubTheme.php">
          <input type="hidden" name="host" value="<?php if(isset($_SERVER['HTTPS'])){ echo "https://" . $_SERVER['SERVER_NAME']; } else{ echo "http://" . $_SERVER['SERVER_NAME']; } ?>">
          <input type="hidden" name="MyApp" value="<?php echo $MyApp; ?>">
          <div class="form-group">
