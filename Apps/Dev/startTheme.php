  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
		<li><a href="#" data-toggle="collapse" data-target="#NewA">Create Theme</a></li>  
	  </ul>
    </div>
  </div>
</nav>
<div id="NewA" class="collapse">
<form method="post" action="<?php wd_urlSub($wd_type, $wd_app, 'startThemeSub.php', ''); ?>">
    <label for="nameA">New Theme Name: </label>
...
<br>
    <div class="panel panel-primary">
      <div class="panel-heading"><b>My Web Themes</b></div>
      <div class="panel-body">
        <table class="table table-striped">
<?php
$x = 0;
foreach (scandir('www/Themes/') as $entry){
                    if ($entry != "." && $entry != "..") {
?>
<tr><td>
<?php
...
echo $x . ": ";
?>
    <a href="<?php wd_url($wd_type, $wd_app, 'MyTheme.php', '&MyApp=' . $entry); ?>"><?php echo $entry; ?></a>
    </td></tr>
<?php
}
}
