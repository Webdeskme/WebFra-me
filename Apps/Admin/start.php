...
<a href="<?php wd_url($wd_type, $wd_app, 'Permissions.php', ''); ?>"><h3>Permissions</h3></a>
<a href="<?php wd_url($wd_type, $wd_app, 'CSV_UP.php', ''); ?>"><h3>CSV Uplode</h3></a>
<a href="<?php wd_url($wd_type, $wd_app, 'Fpath.php', ''); ?>"><h3>File Path</h3></a>
