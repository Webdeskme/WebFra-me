  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="<?php wd_url($wd_type, $wd_app, 'pplugins.php', ''); ?>">Plugins</a></li>
...
<div class="panel panel-primary">
  <div class="panel-heading"><b>Choose Plugins</b></div>
  ...
  <?php
    ...
    <a href="<?php wd_urlSub($wd_type, $wd_app, 'ppluginsSub.php', '&theme=' . $theme); ?>" data-toggle="tooltip" title="<?php if(file_exists("www/Themes/" . $theme . "/tell.txt")){
