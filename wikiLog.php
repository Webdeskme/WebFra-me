...
<body>
  ...
  if(file_exists('www/Wiki/wiki-banner.php')){
    echo file_get_contents('www/Wiki/wiki-banner.php');
  }
  ?>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php" title="Websit"><span class="glyphicon glyphicon-globe"></span></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="wiki.php" title="Wiki-Home"><span class="glyphicon glyphicon-home"></span></a></li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="wiki.php?page=<?php echo $wd_page; ?>&type=edit" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a></li>
      </ul>
    </div>
  </div>
</nav>
  <div class="container">
    ...
    <hr>
    <?php
  if(file_exists('wikiLogFile.php')){
    echo file_get_contents('wikiLogFile.php');
  }
  ?>
    <hr>
    <?php
  if(file_exists('www/Wiki/wiki-footer.php')){
    echo file_get_contents('www/Wiki/wiki-footer.php');
  }
  ?>
  </div>
</body>
